...
const GAMES: GameDef[] = [
  ...
  { icon: '🏴‍☠️', title: 'Pirate Carnage', desc: 'Twisted Metal on the ocean. 1-2P co-op vs 3 bosses at once!', href: '/skills/fun/pirate-carnage', xp: '+25 XP', bg: 'linear-gradient(135deg,#0a2438,#06121e)', glow: '#ff6b2b', featured: true },
]
