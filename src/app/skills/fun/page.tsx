...
const GAMES: GameDef[] = [
  ...
  { icon: '🍷', title: 'Wine Stocker', desc: 'Stock shelves, build displays, and move cases like a pro.', href: '/skills/fun/wine-stocker', xp: '+25 XP (400+ pts)', bg: 'linear-gradient(135deg,#1a0a14,#0e0508)', glow: '#b03060', featured: true },
]
